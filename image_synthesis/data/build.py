...
def build_dataloader(config, args=None, return_dataset=False):
    ...
    train_dataset.shorten_dataset(num_items=50000)

    print('Content of train_dataset: ', len(train_dataset))
    ...
    val_dataset.shorten_dataset(num_items=20000)
    print('Content of valid_dataset: ', len(val_dataset))
